...
[
  ...
  AC_MSG_CHECKING([libleptongui shared library version])
  AC_MSG_RESULT($1)
  AC_SUBST([LIBLEPTONGUI_SHLIB_VERSION], $1)

  VER_MAJOR=`echo ${LIBLEPTONGUI_SHLIB_VERSION} | sed 's;:.*;;g'`
  AC_SUBST([LIBLEPTONGUI_MAJOR], $VER_MAJOR)
])
