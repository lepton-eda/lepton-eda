...
create_MainWindow (void)
{
  ...
  GtkWidget *pMainNotebookXAxisScaleXmaxCheck;
  ...
  GtkWidget *pMainNotebookYAxisScaleYmaxCheck;
  ...
  pMainNotebookXAxisScaleXmaxCheck = gtk_check_button_new_with_label (_("Auto"));
  gtk_widget_ref (pMainNotebookXAxisScaleXmaxCheck);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "pMainNotebookXAxisScaleXmaxCheck", pMainNotebookXAxisScaleXmaxCheck,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (pMainNotebookXAxisScaleXmaxCheck);
  gtk_table_attach (GTK_TABLE (pMainNotebookXAxisScaleTable), pMainNotebookXAxisScaleXmaxCheck, 3, 4, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (pMainNotebookXAxisScaleXmaxCheck), TRUE);
  ...
  pMainNotebookYAxisScaleYmaxCheck = gtk_check_button_new_with_label (_("Auto"));
  gtk_widget_ref (pMainNotebookYAxisScaleYmaxCheck);
  gtk_object_set_data_full (GTK_OBJECT (MainWindow), "pMainNotebookYAxisScaleYmaxCheck", pMainNotebookYAxisScaleYmaxCheck,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (pMainNotebookYAxisScaleYmaxCheck);
  gtk_table_attach (GTK_TABLE (pMainNotebookYAxisScaleTable), pMainNotebookYAxisScaleYmaxCheck, 3, 4, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (pMainNotebookYAxisScaleYmaxCheck), TRUE);
  ...
  gtk_signal_connect (GTK_OBJECT (pMainNotebookXAxisScaleXminCheck), "toggled",
                      GTK_SIGNAL_FUNC (MainNotebookXAxisScaleXminCheck_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (pMainNotebookXAxisScaleXmaxCheck), "toggled",
                      GTK_SIGNAL_FUNC (MainNotebookXAxisScaleXmaxCheck_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (pMainNotebookXAxisMainDxCheck), "toggled",
                      GTK_SIGNAL_FUNC (MainNotebookXAxisMainDxCheck_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (pMainNotebookXAxisAddNumberCheck), "toggled",
                      GTK_SIGNAL_FUNC (MainNotebookXAxisAddNumberCheck_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (pMainNotebookYAxisScaleYminCheck), "toggled",
                      GTK_SIGNAL_FUNC (MainNotebookYAxisScaleYminCheck_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (pMainNotebookYAxisScaleYmaxCheck), "toggled",
                      GTK_SIGNAL_FUNC (MainNotebookYAxisScaleYmaxCheck_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (pMainNotebookYAxisMainDyButton), "toggled",
                      GTK_SIGNAL_FUNC (MainNotebookYAxisMainDyButton_toggled),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (pMainNotebookYAxisAddNumberCheck), "toggled",
                      GTK_SIGNAL_FUNC (MainNotebookYAxisAddNumberCheck_toggled),
                      NULL);
