...
(define backend (string-append top-srcdir "netlist/scheme/backend/gnet-spice-noqsi.scm"))
(define symbol-lib (string-append top-srcdir "symbols"))
(define schematic-base (string-append top-srcdir "netlist/examples/spice-noqsi/HelloWorld/HelloWorld"))
