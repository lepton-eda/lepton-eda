...
main (int argc, char *argv[])
{
    ...
    g_test_add_func ("/geda/libgeda/angle/isnormal",
                     check_is_normal);

    g_test_add_func ("/geda/libgeda/angle/isortho",
                     check_is_ortho);

    g_test_add_func ("/geda/libgeda/angle/makeortho",
                     check_make_ortho);

    g_test_add_func ("/geda/libgeda/angle/normalize",
                     check_normalize);
