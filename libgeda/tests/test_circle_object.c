...
main (int argc, char *argv[])
{
  ...
  g_test_add_func ("/geda/libgeda/circle_object/construction",
                   check_construction);

  g_test_add_func ("/geda/libgeda/circle_object/check_accessors",
                   check_accessors);

  g_test_add_func ("/geda/libgeda/circle_object/serialization",
                   check_serialization);
