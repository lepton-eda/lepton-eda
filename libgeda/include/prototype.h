...
void f_image_write(TOPLEVEL *w_current, char *filename, int width, int height);
...
void o_arc_image_write(TOPLEVEL *w_current, OBJECT *o_current, int origin_x, int origin_y);
...
void o_box_image_write(TOPLEVEL *w_current, OBJECT *o_current, int origin_x, int origin_y);
...
void o_circle_image_write(TOPLEVEL *w_current, OBJECT *o_current, int origin_x, int origin_y);
...
gdImagePtr o_image_geda2gd_color(int color);
/* o_line_basic.c */
...
void o_line_image_write(TOPLEVEL *w_current, OBJECT *o_current, int origin_x, int origin_y);
...
void o_net_image_write(TOPLEVEL *w_current, OBJECT *o_current, int origin_x, int origin_y);
...
void o_pin_image_write(TOPLEVEL *w_current, OBJECT *o_current, int origin_x, int origin_y);
