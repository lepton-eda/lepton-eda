...
void o_net_CONN_recalc_only(TOPLEVEL *w_current, OBJECT *o_current);
void o_net_CONN_recalc(TOPLEVEL *w_current, OBJECT *object_list);
...
void o_pin_CONN_recalc_only(TOPLEVEL *w_current, OBJECT *o_current);
void o_pin_CONN_recalc(TOPLEVEL *w_current, OBJECT *object_list);
