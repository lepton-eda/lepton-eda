...
void o_arc_print_solid(TOPLEVEL *w_current, FILE *fp, OBJECT *o_current, int x, int y, int width, int height, int color, int angle1, int angle2, int arc_width, int length, int space, int origin_x, int origin_y);
void o_arc_print_dotted(TOPLEVEL *w_current, FILE *fp, OBJECT *o_current, int x, int y, int width, int height, int color, int angle1, int angle2, int arc_width, int length, int space, int origin_x, int origin_y);
void o_arc_print_dashed(TOPLEVEL *w_current, FILE *fp, OBJECT *o_current, int x, int y, int width, int height, int color, int angle1, int angle2, int arc_width, int length, int space, int origin_x, int origin_y);
void o_arc_print_center(TOPLEVEL *w_current, FILE *fp, OBJECT *o_current, int x, int y, int width, int height, int color, int angle1, int angle2, int arc_width, int length, int space, int origin_x, int origin_y);
void o_arc_print_phantom(TOPLEVEL *w_current, FILE *fp, OBJECT *o_current, int x, int y, int width, int height, int color, int angle1, int angle2, int arc_width, int length, int space, int origin_x, int origin_y);
