...
ALES *o_ales_add(ALES *list_head, OBJECT *item, OBJECT *responsible, int type, int x, int y);
void o_ales_free(ALES *current);
void o_ales_free_all(ALES *list);
void o_ales_print(ALES *ales);
void o_ales_print_hash_func(gpointer key, gpointer value, gpointer user_data);
void o_ales_print_hash(GHashTable *ales_table);
...
OBJECT *o_ntext_add_head(void);
void o_ntext_init(void);
void o_ntext_print_set(void);
OBJECT *o_ntext_load_font(TOPLEVEL *w_current, char needed_char);
int o_ntext_width(TOPLEVEL *w_current, char *string, int size);
OBJECT *o_ntext_create_string(TOPLEVEL *w_current, OBJECT *object_list, char *string, int size, int color, int x, int y, int angle);
OBJECT *o_ntext_add(TOPLEVEL *w_current, OBJECT *object_list, char type, int color, int x, int y, int angle, char *string, int size, int visibility, int show_name_value);
void o_ntext_recalc(TOPLEVEL *w_current, OBJECT *o_current);
OBJECT *o_ntext_read(TOPLEVEL *w_current, OBJECT *object_list, char buf[], char string[], char *version);
void o_ntext_set_info_font(char buf[]);
char *o_ntext_save(char *buf, OBJECT *object);
void o_ntext_recreate(TOPLEVEL *w_current, OBJECT *o_current);
void o_ntext_translate(TOPLEVEL *w_current, int dx, int dy, OBJECT *object);
void o_ntext_translate_world(TOPLEVEL *w_current, int x1, int y1, OBJECT *o_current);
OBJECT *o_ntext_copy(TOPLEVEL *w_current, OBJECT *list_tail, OBJECT *o_current);
void o_ntext_freeallfonts(TOPLEVEL *w_current);
void o_ntext_print(TOPLEVEL *w_current, FILE *fp, OBJECT *o_current, int origin_x, int origin_y);
void o_ntext_rotate_lowlevel(TOPLEVEL *w_current, int world_centerx, int world_centery, int angle, OBJECT *object);
void o_ntext_rotate_world(TOPLEVEL *w_current, int world_centerx, int world_centery, int angle, int angle_change, OBJECT *object);
