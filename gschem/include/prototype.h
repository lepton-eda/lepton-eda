...
SCM g_key_view_updatenets(void);
...
SCM g_rc_override_net_color(SCM color);
SCM g_rc_override_pin_color(SCM color);
SCM g_rc_attribute_color(SCM color);
SCM g_rc_detachedattr_color(SCM color);
SCM g_rc_text_color(SCM color);
SCM g_rc_net_color(SCM color);
SCM g_rc_pin_color(SCM color);
SCM g_rc_graphic_color(SCM color);
SCM g_rc_grid_color(SCM color);
SCM g_rc_background_color(SCM color);
SCM g_rc_select_color(SCM color);
SCM g_rc_boundingbox_color(SCM color);
SCM g_rc_net_endpoint_color(SCM color);
...
SCM g_rc_stroke_color(SCM color);
...
void i_callback_options_show_status(gpointer data, guint callback_action, GtkWidget *widget);
...
void i_callback_options_show_coord(gpointer data, guint callback_action, GtkWidget *widget);
/* i_sbox.c */
...
gint color_black(GtkWidget *w, TOPLEVEL *w_current);
gint color_white(GtkWidget *w, TOPLEVEL *w_current);
gint color_red(GtkWidget *w, TOPLEVEL *w_current);
gint color_green(GtkWidget *w, TOPLEVEL *w_current);
gint color_blue(GtkWidget *w, TOPLEVEL *w_current);
gint color_yellow(GtkWidget *w, TOPLEVEL *w_current);
gint color_cyan(GtkWidget *w, TOPLEVEL *w_current);
gint color_grey(GtkWidget *w, TOPLEVEL *w_current);
